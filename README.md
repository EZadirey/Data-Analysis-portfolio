...
|2|Анализ бизнес показателей|Оценка окупаемости рекламы и рекомендаци для рекламного отдела" на базе трех рекламных данных : визитах, заказах и рекламных расходах|python,pandas,numpy,matplotlib,seaborn,mystem,counter,stats|
|3|
